...
/**
 * A {@link ListAdapter} which wraps a
 * {@link StickyHeadersSwipeToDismissAdapter} and automatically handles wrapping
 * the result of
 * {@link StickyHeadersSwipeToDismissAdapter#getView(int, android.view.View, android.view.ViewGroup)}
 * and
 * {@link StickyHeadersSwipeToDismissAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)}
 * appropriately.
 * 
 * @author Jake Wharton (jakewharton@gmail.com)
 */
class StickyHeadersSwipeToDismissAdapterWrapper extends BaseAdapter implements
		StickyHeadersSwipeToDismissAdapter {
	...
	StickyHeadersSwipeToDismissAdapterWrapper(Context context,
	...
	StickyHeadersSwipeToDismissAdapter getDelegate() {
		return delegate;
	}

	@Override
	public String getStringHeader(int position) {
		return delegate.getStringHeader(translateListViewPosition(position));
	}
