 ...
 */
public interface StickyHeadersSwipeToDismissListViewListener {
	 ...
	 *          to right
	 */
	void onStartOpen(int position, int action, boolean right, View view);
	/**
	 * Called when the swipe changed
	 */
	void onSwipeChanged(boolean right, View backView);
	/**
	 * Start close item
	 * 
	 * @param position
	...
	/**
	 * Used when user want to change swipe list mode on some rows. Return SWIPE_MODE_DEFAULT if you
	 * don't want to change swipe list mode
	 * 
	 * @param position
